...
const connectWebSocket = () => { 
  ...
  TRANSCRIPTION_LANGUAGES.forEach(languageObj => {
    const language_name = Object.keys(languageObj)[0];
  ...
  sharedData.current_socket = sharedData.sockets[0];
...
async function updateListeningLanguage() {
  ...
  // Set the new socket
  sharedData.current_socket = sharedData.sockets[language_index];
